...
$ram = $_POST["fname3"];
$pins = $_POST["fname4"];
$chanels = $_POST["fname5"];
$res = $_POST["fname6"];
$comp = $_POST["fname7"];
$timer8 = sizeof ($_POST["fname8"]);
$timer16 = sizeof ($_POST["fname16"]);
$serial = $_POST["fname9"];
$speed = $_POST["fname10"];
$intosc = sizeof ($_POST["fname11"]);
$sql = "SELECT * FROM micros, analog, digital, speeds, memorytype, presentation where  micros.micro_id=analog.adc_id and micros.micro_id=digital.dig_id and micros.micro_id=speeds.speed_id and micros.packages=presentation.box_id and micros.memorytype=memorytype.type_id and progmemory>=$space and eeprom>=$eeprom and ram>=$ram and pins>=$pins and ADC>=$chanels and res>=$res and comp>=$comp and timer16>=$timer16 and timer8>=$timer8 and serial<>'$serial' and max>=$speed and intOSC>=$intosc order by micro_id";
